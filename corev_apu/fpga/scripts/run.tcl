...
set_property include_dirs { "src/axi_sd_bridge/include" "../../common/submodules/common_cells/include" "../axi/include" "../../idma/include" "../register_interface/include/"} [current_fileset]
